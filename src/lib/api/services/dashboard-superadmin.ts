...
export const SuperAdminDashboard = {
  ...
  async getDailyRevenueChart(days: number): Promise<DailyRevenueChartResponse> {
    try {
      const response = await apiClient.get<DailyRevenueChartResponse>(
        "/api/dashboard/superadmin/revenue",
        {
          params: { days },
        },
      );
  ...
  async getVolumeByBranch(limit: number): Promise<VolumeBranchResponse> {
    try {
      const response = await apiClient.get<VolumeBranchResponse>(
        "/api/dashboard/superadmin/shipment-volume",
        {
          params: { limit },
        },
      );
  ...
  async getShipmentStatusDistribution(): Promise<ShipmentStatusDistributionResponse> {
    try {
      const response = await apiClient.get<ShipmentStatusDistributionResponse>(
        "/api/dashboard/superadmin/shipment-status",
      );
      return response.data;
    } catch (error) {
      const errorMessage = handleAxiosError(error as AxiosErrorType);
  ...
  async getBranchPerformanceRanking(): Promise<BranchPerformanceRankingResponse> {
    try {
      const response = await apiClient.get<BranchPerformanceRankingResponse>(
        "/api/dashboard/superadmin/branch-ranking",
      );
      return response.data;
    } catch (error) {
      const errorMessage = handleAxiosError(error as AxiosErrorType);
  ...
  async getRecentShipments({
    ...
    page: number;
  }): Promise<RecentShipmentsResponse> {
    try {
      const response = await apiClient.get<RecentShipmentsResponse>(
        "/api/dashboard/superadmin/recent-shipments",
        {
  ...
  async getDashboardAlerts({
    ...
    try {
      const response = await apiClient.get<DashboardAlertsResponse>(
        "/api/dashboard/superadmin/alerts",
        {
          params: { limit, page },
        },
      );
