...
export interface ExpiredPaymentAlert {
...
export interface StuckPackageAlert {
  type: "stuck_package";
  description: string;
  shipmentId: number;
  trackingNumber: string;
...
export interface HighQueueBranchAlert {
  type: "high_queue_branch";
  description: string;
  branchId: number;
  branchName: string;
...
export type DashboardAlert =
  ExpiredPaymentAlert | StuckPackageAlert | HighQueueBranchAlert;
